...
\begin{figure}
  ...
  \caption{Drift speed as a function of basic reproductive number \(R_0\), mutation rate \(m\), or cross-immunity distance \(r\).}
  \label{fig:SpeedRMC}
\end{figure}
...
\begin{figure}
  \centering
  \includegraphics[width=4in,height=3in]{figures/SpeedRlinear}
  \caption{Drift speed as a function of basic reproductive number \(R_0\). The blue-triangle points give the numerical results, while red-circle points provide the suggestions of the linear conjecture.}
  \label{fig:SpeedRlinear}
\end{figure}
