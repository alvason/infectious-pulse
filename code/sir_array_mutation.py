...
plt.text(0,2.0/3,r'$ \frac{\partial S_i(t)}{\partial t} =          -\beta S_i(t)I(t) +\mu N -\mu S_i(t)$', fontsize = 1.2*AlvaFontSize)
plt.text(0,1.0/3,r'$ \frac{\partial I_i(t)}{\partial t} =          +\beta S_i(t)I(t) - \gamma I_i(t) -\mu I_i(t) + m \frac{I_{i-1}(t) - 2I_i(t) + I_{i+1}(t)}{(\Delta i)^2}$'
         , fontsize = 1.2*AlvaFontSize)
plt.text(0,0.0/3,r'$ \frac{\partial R_i(t)}{\partial t} =          +\gamma I_i(t) - \mu R_i(t) $', fontsize = 1.2*AlvaFontSize)
plt.show()
